...
public class Configurador extends WebMvcConfigurerAdapter {
	...
	//Tratamento do erro de Lazy (sob demanda nas views) que ocorre com relacionamento @Many
	//O spring abre EntityManager no inicio da requisição e fecha no final 
	@Bean
